...
<sx:div id="listmt_allDiv">
    <s:if test="#request.sSub_ServiceList_MO !=null">
      <%--  <s:select list="#request.sSub_ServiceList_MO"
                  listKey="sub_service_name" listValue="sub_service_name"
                  headerKey="-1" headerValue="--Chọn gói cước--"
                  name="mt_allManagerForm.sub_service_name"
                  id="mt_allManagerForm.sub_service_name" cssStyle="width:150px;">
        </s:select> --%>
        <select
            name="mt_allManagerForm.sub_service_name"
            id="mt_allManagerForm.sub_service_name" cssStyle="width:150px;">
            <option value="-1" > <fmt:message key="sub.choose" /></option>
            <c:forEach items="${sSub_ServiceList_MO}" var="data">
