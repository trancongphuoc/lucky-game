<%-- 
    Document   : Stats_Daily_Sub_Service
...
<sx:div id="listStats_Daily_Sub_ServiceDiv">
    <s:if test="#request.Stats_ReSub_ServiceList !=null">
       <%-- <s:select list="#request.Stats_ReSub_ServiceList"
                  ...
                  name="Stats_DailyManagerForm.sub_service_name"
                  id="Stats_DailyManagerForm.sub_service_name" cssStyle="width:150px;">
        </s:select>    --%>
        <select
            name="Stats_DailyManagerForm.sub_service_name"
            id="Stats_DailyManagerForm.sub_service_name" cssStyle="width:150px;">
