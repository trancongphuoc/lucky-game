...
<sx:div id="listStats_Subscribers_Sub_ServiceDiv">
    <s:if test="#request.Stats_SubSub_ServiceList !=null">
       <%-- <s:select list="#request.Stats_SubSub_ServiceList"
                  listKey="sub_service_name" listValue="sub_service_name"
                  headerKey="-1" headerValue="--Chọn gói cước--"
                  name="Stats_SubscribersManagerForm.sub_service_name"
                  id="Stats_SubscribersManagerForm.sub_service_name" cssStyle="width:150px;">
        </s:select>--%>
        <select
            name="Stats_SubscribersManagerForm.sub_service_name"
            id="Stats_SubscribersManagerForm.sub_service_name" cssStyle="width:150px;">
            <option value="-1" > <fmt:message key="sub.choose" /></option>
            <c:forEach items="${Stats_SubSub_ServiceList}" var="data">
