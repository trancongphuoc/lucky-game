...
<sx:div id="listStats_Error_ServiceDiv">    
    <s:if test="#request.ServicesList !=null">
        <select    onchange="searchSub_Service_Stats_E()"
                   name="Stats_ErrorManagerForm.service_name"
                   id="Stats_ErrorManagerForm.service_name" cssStyle="width:150px;">
