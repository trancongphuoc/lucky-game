...
<%
	...
	String debugModeStr= request.getParameter("debugMode"); // not used in Free version
        ...
        if (chartSWF ==null || chartSWF ==""){
            chartSWF = "/cms/share/FsCharts/MSLine.swf";
        }
        if (strXML ==null || strXML ==""){
            strXML = xmlData;
        }
        if (chartWidthStr ==null || chartWidthStr ==""){
            chartWidthStr = "1000";
        }
        if (chartHeightStr ==null || chartHeightStr ==""){
            chartHeightStr = "500";
        }
...
%> 
			...
			<object style="z-index:-999;" classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://fpdownload.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=8,0,0,0"
			...
			<embed wmode="transparent" src="<%=chartSWF%>" FlashVars="<%=strFlashVars%>" 
