...
<sx:div id="listTransactionsDiv">
    <s:if test="#request.sSub_ServiceList !=null">
       <%-- <s:select list="#request.sSub_ServiceList"
                  listKey="sub_service_name" listValue="sub_service_name"
                  headerKey="-1" headerValue="--Chọn gói cước--"
                  name="TransactionsManagerForm.sub_service_name"
                  id="TransactionsManagerForm.sub_service_name" cssStyle="width:150px;">
        </s:select> --%>
        <select name="TransactionsManagerForm.sub_service_name"
                id="TransactionsManagerForm.sub_service_name" cssStyle="width:150px;">
            <option value="-1"><fmt:message key="sub.choose" /></option>
            <c:forEach items="${sSub_ServiceList}" var="data">
