 ...
 * @author haind25
 */
public class PromotionCommandsManagerEditForm implements Serializable{
    ...
    */
    ...
    private String promotionChannel; //kenh duoc huong khuyen mai, COMMAND_SMS, ...
    private int status;
    ...
    public PromotionCommandsManagerEditForm(){
        status = 1;//fix default active
        fromDate = new Date();
//        toDate = new Date(fromDate.getTime() + ONE_DAY);
    }
    
    public PromotionCommandsManagerEditForm(String id, String subServiceName, String code, int status, 
            String promotionChannel, String description, String successMessage,
