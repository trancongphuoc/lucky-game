 ...
 * @author hanhnv62
 */
public class Service_mo_priceManagerEditForm {
    ...
    public Service_mo_priceManagerEditForm() {
    }
    ...
    /**
     * @return the add_monfee_circle_day
     */
    public String getAdd_monfee_circle_day() {
        return add_monfee_circle_day;
    }

    /**
     * @param add_monfee_circle_day the add_monfee_circle_day to set
     */
    public void setAdd_monfee_circle_day(String add_monfee_circle_day) {
        this.add_monfee_circle_day = add_monfee_circle_day;
    }
