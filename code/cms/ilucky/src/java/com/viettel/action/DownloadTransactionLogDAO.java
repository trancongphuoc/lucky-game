 ...
 *
 */
public class DownloadTransactionLogDAO extends BaseDAOMDBAction {

    private static final Log log = LogFactory.getLog(DownloadTransactionLogDAO.class);
    ...
    public String downloadFile() {
        try {
            ...
            String fileName = "TransactionHis_" + msisdn + "_" + format.format(new Date())+ (new Random()).nextInt(1000000)+".xls";
...
//                setInputStream(new ByteArrayInputStream(bytes));
                InputStream inputStream = getStream(msisdn, fromDate, toDate) ;
                if (inputStream == null) {
                    return  "error" ;
                }
...
//        fields.add("id");
        fields.add("msisdn");
        fields.add("trans_id");
        fields.add("request_time");
        fields.add("response_code");
        fields.add("sub_service_name");
        fields.add("cmd");
        fields.add("price");
        fields.add("contents");
        fields.add("channel");
        ...
        headerCellTitle.setCellValue("Transaction_his_" + msisdn +"_" + fromDate);
        ...
        List<TransactionsBO> datas = TransactionsManagerAction.getListTrans(msisdn, fromDate, toDate);
        if (datas == null ) {
            return null;
        }
        int columnCount = 0;
...
//                    }
                    ...
                    Logger.getLogger(DownloadTransactionLogDAO.class.getName()).log(Level.SEVERE, null, ex);
