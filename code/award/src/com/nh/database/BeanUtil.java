...
public class BeanUtil {
    ...
    public static final TableInfo init(Class<?> entityClass) {
        ...
        for (Method method : methods) {
            ...
            if (id != null) {
                if (fi.getIdColumnName() == null
                        || (method.getClass().getName().equals(entityClass.getName()))) {
        ...
        List<Field> fields = new ArrayList<>(publicFields.length + privateFields.length);
        fields.addAll(Arrays.asList(publicFields));
        fields.addAll(Arrays.asList(privateFields));
