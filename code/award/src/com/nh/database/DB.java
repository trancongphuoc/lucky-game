...
public class DB {
    ...
    /**
     * Su dung synchronized trong truong hop tai mot thoi diem co nhieu noi goi getDB().
     * 22.08.2014 tulv2
     *
 * @return  */
    ...
    public DataSource getDataSource(){
        return ConnectionPoolManager.getDefaltDataSource(null);
    }
    ...
    public static Integer queryForInt(String sql, Object...args) {
        return getDB().getJdbcTemplate().queryForObject(sql, Integer.class, args);
    }
...
//        }
	...
	/** 
	 * tra lai lenh insert vao table cua mot entity, 
	 * truong ID luon dung dau tien
	 * @author hadc
	 * */
	...
	/** 
	 * tra lai lenh insert vao table cua mot entity, 
	 * truong ID: ko lay gia tri trong DB, ma tra ve luon la 
	 * @author hadc
	 * */
     ...
     * @param entity
     * @param
     * type phuc vu cho muc dich lay du lieu
     *
     * <ul>
     ...
     * </ul>
     * @return
     * 	Object[] trong do Object[0] la id trong truong hop type = PO.SQL_INSERT
     * @author hadc
     * @param <E>
     * */
